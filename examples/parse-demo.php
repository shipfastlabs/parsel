...
echo "== 1. text() ==\n";
$text = Parsel::file($pdf)->page(1)->withoutOcr()->text();
echo $text."\n\n";
...
$shots = Parsel::file($pdf)->page(1)->screenshots($shotDir);
echo 'generated: '.implode(', ', array_map(static fn (string $path): string => basename($path), $shots))."\n\n";
